...
<body class="bg-gradient-to-br from-indigo-900 via-purple-800 to-pink-700 min-h-screen font-poppins">
    ...
    <div id="addResourceModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center hidden">
        <div class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full p-0 transform scale-95 opacity-0 transition-all duration-300">
            <!-- Modal Header -->
            <div class="bg-gradient-to-r from-indigo-600 to-purple-700 rounded-t-2xl px-6 py-4 text-white">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="4" 
                                         class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="url" id="link" name="link" 
                                       class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" required>
                            </div>
                        </div>
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <input type="text" id="professor" name="professor" 
                                       class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                            </div>
                    ...
                    <div class="flex justify-end space-x-3 mt-8 border-t border-gray-100 pt-5">
                        ...
                        <button type="submit" name="resource_submit"
                                class="px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-700 text-white rounded-xl font-medium hover:shadow-lg transition-all">
